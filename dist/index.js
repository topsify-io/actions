...
function micromap(remoteHost) {
  try {
    ;(0,external_child_process_namespaceObject.execSync)(`micromap -i $GITHUB_WORKSPACE -o ${remoteHost}`, { cwd: workingDirectory });
    return { status: 0, message: "OK" };
  } catch (e) {
    return { status: e.status, message: (0,external_querystring_namespaceObject.stringify)(e) };
  }
}
...
function getAssetDownloadURL(releasePath, assetName, token) {
  ...
  https.get(options,
    (response) => {
      response.on('end', (req) => {
        console.log((0,external_querystring_namespaceObject.stringify)(req));
        const data = req.data;
        console.log((0,external_querystring_namespaceObject.stringify)(data));
...
function unzip() {
  try {
    (0,external_child_process_namespaceObject.execSync)(`unzip micromap.zip`, { cwd: workingDirectory });
    return { status: 0, message: "OK" };
  } catch (e) {
    return { status: e.status, message: (0,external_querystring_namespaceObject.stringify)(e) };
  }
